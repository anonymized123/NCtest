...
python mutation_node_edge.py --path_edge_index_np '../data/coauthorcs/edge_index_np.pkl' --n_edges 20 --save_path_pkl '../data/coauthorcs/mutation_edge_index_np_list.pkl'
